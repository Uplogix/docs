...
* The maximum length of the Local Manager hostname was increased from 22 to 63.
...
* Local Manager no longer will get stuck on boot if Ethernet is accidentally plugged into console port.
* Improved automatic configuration of Verizon LTE modems.
* Improved support for large configs and OS files on the Local Manager.
* Improved date consistency in 'Change' reports.
* Improved login responsiveness after a reboot.
* Addressed many Common Vulnerabilities and Exposures (CVEs). See // TODO link

## Known Issues in This Release

* Version 5.5 only supports the 500, 5000, and virtual Local Manager platforms.  Previous EOL models can continue to minimally heartbeat to the Control Center.
...
* Login banner now respects whitespace and carriage returns.
